...
[입력 처리 규칙]
1. 입력이 **한국어**인 경우: 가장 자연스러운 일본어 문장으로 번역한 후, 번역된 일본어 문장을 기준으로 분석을 진행합니다.
2. 입력이 **일본어**인 경우: 원문 그대로 분석을 진행합니다.
3. 원문에 오타나 어색한 문법이 있다면 자연스럽게 교정한 일본어 문장을 기준으로 분석합니다.
...
해석 5개 주세요
단어장
\`5つ\` (いつつ) 5개, 다섯 | 품사=명사 | 문자=히라가나
\`ください\` (ください) 주세요 | 품사=동사 | 문자=히라가나
문법
\`ください\` 동사 \`くださる\`의 명령형으로, 상대에게 정중하게 요청할 때 사용합니다. 명사 뒤에 붙어 "~을/를 주세요"라는 의미를 나타냅니다.`;
